...
class SmallCpscRecallCard extends ConsumerStatefulWidget {
  final RecallData recall;

  const SmallCpscRecallCard({super.key, required this.recall});

  @override
  ConsumerState<SmallCpscRecallCard> createState() => _SmallCpscRecallCardState();
}

class _SmallCpscRecallCardState extends ConsumerState<SmallCpscRecallCard> {
  ...
  /// Navigate directly to CPSC details page
  void _navigateToDetailsPage(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CpscRecallDetailsPage(recall: widget.recall),
      ),
    );
  }
