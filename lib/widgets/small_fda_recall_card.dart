...
class SmallFdaRecallCard extends ConsumerStatefulWidget {
  final RecallData recall;

  const SmallFdaRecallCard({super.key, required this.recall});

  @override
  ConsumerState<SmallFdaRecallCard> createState() => _SmallFdaRecallCardState();
}

class _SmallFdaRecallCardState extends ConsumerState<SmallFdaRecallCard> {
