...
class NHTSATireRecallDetailsCard extends StatelessWidget {
  final RecallData recall;
  const NHTSATireRecallDetailsCard({super.key, required this.recall});
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: const [
                    Icon(Icons.circle, color: Colors.black87, size: 14),
                    SizedBox(width: 4),
                    Text(
                      'Tire',
                      style: TextStyle(
