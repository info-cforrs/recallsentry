...
import '../widgets/shared/shared_cpsc_resources_section.dart';
import '../widgets/cpsc_recall_details_card.dart';
...
class CpscRecallDetailsPage extends StatefulWidget {
  ...
  const CpscRecallDetailsPage({super.key, required this.recall});
...
class _CpscRecallDetailsPageState extends State<CpscRecallDetailsPage> with HideOnScrollMixin {
  ...
  Future<void> _fetchLatestRecall() async {
    ...
    try {
      final recalls = await RecallDataService().getCpscRecalls(
        forceRefresh: true,
      );
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // CPSC Recall Details Card
              CPSCRecallDetailsCard(recall: recall),
              ...
              // CPSC Resources Section
              SharedCpscResourcesSection(recall: recall),
              ...
              Column(
                ...
                children: [
                  Semantics(
                    label: 'Open CPSC Recall Link',
                    button: true,
                    child: TextButton(
                      style: TextButton.styleFrom(
                        backgroundColor: const Color(0xFF1565C0), // Blue for CPSC
              ...
              Column(
                ...
                children: [
                  Text(
                    recall.fieldRecallNumber.isNotEmpty
    ...
    return FutureBuilder<SubscriptionInfo>(
      ...
      builder: (context, subscriptionSnapshot) {
        ...
        return FutureBuilder<Map<String, dynamic>>(
          future: recall.databaseId != null
              ? _getEnrollmentForCurrentUser(recall.databaseId!)
              : Future.value({'enrollment': null}),
          builder: (context, snapshot) {
