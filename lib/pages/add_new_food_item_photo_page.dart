...
import 'add_new_food_item_details_page.dart';
...
class AddNewFoodItemPhotoPage extends StatefulWidget {
  ...
  @override
  State<AddNewFoodItemPhotoPage> createState() =>
      _AddNewFoodItemPhotoPageState();
}

class _AddNewFoodItemPhotoPageState
    extends State<AddNewFoodItemPhotoPage> with WidgetsBindingObserver {
  ...
  Future<void> _proceedToNextPage() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => AddNewFoodItemDetailsPage(
